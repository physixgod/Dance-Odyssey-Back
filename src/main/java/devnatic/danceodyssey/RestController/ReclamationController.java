...
public class ReclamationController {
    ...
    @PostMapping("/AddReclamation/{idDancer}")
    public ResponseEntity<Reclamation> Addreclamation(@RequestBody Reclamation reclamation,@PathVariable("idDancer") int idDancer){
        Reclamation newReclamarion =reclamationServices.Addreclamation(reclamation,idDancer);
